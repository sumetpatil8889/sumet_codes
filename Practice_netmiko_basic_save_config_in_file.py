...
for IP123 in list_of_devices_IPs:
    ...
    #print(f" Name of the device is {device_name123} and its config is below: ")
    with open(r"C:\Users\spsp1\PycharmProjects\Python_Auto_Practice\backup_" + device_name123 + "_" + IP123 + ".txt", "a") as f:
        output123 = ssh123.send_command("show run")
        f.write(output123)  # Use write command
